...
/*ctr*/
    ...
    m_deviceLink (0)
  {
    ...
    m_runningConfiguration->setDataType (UaNodeId (OpcUaType_Double, 0));	// assumption: BuiltInTypeId matches numeric address of the type in namespace0
...
/* generate setters and getters (if requested) */
  ...
  UaStatus ASPurityMonitor::setRunningConfiguration (const OpcUa_Double value,
						     OpcUa_StatusCode
						     statusCode,
						     const UaDateTime &
						     srcTime)
  ...
  UaStatus ASPurityMonitor::getRunningConfiguration (OpcUa_Double & r) const
  {
  ...
  /* short getter (possible because this variable will never be null) */
  OpcUa_Double ASPurityMonitor::getRunningConfiguration () const
  {
