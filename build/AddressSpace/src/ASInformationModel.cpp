...
namespace AddressSpace
{
  ...
  void ASInformationModel::createNodesOfTypes (ASNodeManager * nm)
  {
    ...
    type =
      new UaObjectTypeSimple ("Controller",
			      UaNodeId (AS_TYPE_CONTROLLER,
					nm->getNameSpaceIndex ()),
			      /* locale id */ UaString (""), /*is abstract */
			      OpcUa_False);
    addStatus =
    ...
    type =
      new UaObjectTypeSimple ("TemperatureProbe",
			      UaNodeId (AS_TYPE_TEMPERATUREPROBE,
					nm->getNameSpaceIndex ()),
			      /* locale id */ UaString (""), /*is abstract */
			      OpcUa_False);
    addStatus =
    ...
    type =
      new UaObjectTypeSimple ("AirFlowProbe",
			      UaNodeId (AS_TYPE_AIRFLOWPROBE,
					nm->getNameSpaceIndex ()),
			      /* locale id */ UaString (""), /*is abstract */
			      OpcUa_False);
    addStatus =
    ...
    type =
      new UaObjectTypeSimple ("PurityMonitor",
			      UaNodeId (AS_TYPE_PURITYMONITOR,
					nm->getNameSpaceIndex ()),
			      /* locale id */ UaString (""), /*is abstract */
			      OpcUa_False);
    addStatus =
