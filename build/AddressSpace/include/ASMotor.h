...
/* NOTE: This function is not intended to be used by human being. */
    ...
    UaStatus callTurnOn (MethodManagerCallback * pCallback,
			 OpcUa_UInt32 callbackHandle,
			 const UaVariantArray & inputArguments);

    UaStatus callGetDiagnostics (MethodManagerCallback * pCallback,
				 OpcUa_UInt32 callbackHandle,
				 const UaVariantArray & inputArguments);
  ...
  private:
    ...
    /* Methods */
      ...
      ASDelegatingMethod < ASMotor > *m_turnOn;

      ASDelegatingMethod < ASMotor > *m_getDiagnostics;
