...
namespace Device
{
  ...
  public:
    ...
    void add (DPurityMonitor * d)
    {
      m_childrenPurityMonitor.push_back (d);
    }
    const std::vector < DPurityMonitor * >&puritymonitors () const
    {
      return m_childrenPurityMonitor;
    }
  ...
  private:
    ...
    std::vector < DPurityMonitor * >m_childrenPurityMonitor;
