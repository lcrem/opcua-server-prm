...
namespace Device
{
  ...
  DAirFlowProbe *Base_DMotor::airflowprobe () const
  {
    if (m_AirFlowProbes.size () != 1)
      throw std::
	runtime_error
	("Configuration error: Motor should have exactly 1 AirFlowProbe ");
      return m_AirFlowProbes.at (0);
  }
  ...
  /* Constructor */
  Base_DMotor::Base_DMotor (const Configuration::Motor & config,
			    Parent_DMotor * parent):m_parent (parent),
    m_addressSpaceLink (0),
